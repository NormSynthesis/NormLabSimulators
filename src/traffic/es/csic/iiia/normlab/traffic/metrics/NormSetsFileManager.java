...
//	private TrafficMetrics metrics;
	private TrafficNormSynthesisAgent ironAgent;
	 ...
	 * Constructor
	 */
	public NormSetsFileManager(TrafficMetrics metrics, TrafficNormSynthesisAgent ironAgent, boolean convergence) {
...
//		this.metrics = metrics;
	...
	public void load() {
		...
		if(this.convergence){
			finalNormSetsFilename = TrafficNormSynthesisSettings.SIM_DATA_PATH + "/Converged" + TrafficNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE;
			finalNormSetsPlotFilename = TrafficNormSynthesisSettings.SIM_DATA_PATH + "/Converged" + TrafficNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE + ".plot";
		}
		else {
			finalNormSetsFilename = TrafficNormSynthesisSettings.SIM_DATA_PATH + "/NotConverged" + TrafficNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE;
			finalNormSetsPlotFilename = TrafficNormSynthesisSettings.SIM_DATA_PATH + "/NotConverged" + TrafficNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE + ".plot";
		}
...
//				output.write(String.valueOf(covNormSets.get(normSet)) + "\n");
	...
	private void updateData() {
		StringList currNormSet = new StringList(ironAgent.getNormativeSystem());
