...
//		this.finalNorms = new HashMap<String, Integer>();
	 ...
	 */
	public void load() {
//		String totalNormsFilename = TrafficConfiguration.SIM_DATA_PATH + "/" + TrafficConfiguration.SIM_TOTAL_NORMS_FILE;
//		String totalNormsPlotFilename = TrafficConfiguration.SIM_DATA_PATH + "/" + TrafficConfiguration.SIM_TOTAL_NORMS_FILE + ".plot";
//		String finalNormsFilename = TrafficConfiguration.SIM_DATA_PATH + "/" + TrafficConfiguration.SIM_FINAL_NORMS_FILE;
//		String finalNormsPlotFilename = TrafficConfiguration.SIM_DATA_PATH + "/" + TrafficConfiguration.SIM_FINAL_NORMS_FILE + ".plot";
...
//		String norm = "";
//
//		for(Norm n : Main.getNormsManager().getNorms()) {
//			norm = "N\n";
//			norm += n.getView() + "-" + n.getAction() + "\n";
//
//			// Total norms
...
//			if(n.getState() == NormState.Active) {
