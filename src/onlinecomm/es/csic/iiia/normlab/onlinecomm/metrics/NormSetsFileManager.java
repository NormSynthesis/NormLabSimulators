...
//	private TrafficMetrics metrics;
	 ...
	 * Constructor
	 */
	public NormSetsFileManager(NormSynthesisMetrics metrics, 
	...
	public void load() {
		...
		if(this.convergence){
			finalNormSetsFilename = CommunityNormSynthesisSettings.SIM_DATA_PATH + 
					"/Converged" + CommunityNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE;
			finalNormSetsPlotFilename = CommunityNormSynthesisSettings.SIM_DATA_PATH +
					"/Converged" + CommunityNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE
					+ ".plot";
		}
		else {
			finalNormSetsFilename = CommunityNormSynthesisSettings.SIM_DATA_PATH + 
					"/NotConverged" + CommunityNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE;
			finalNormSetsPlotFilename = CommunityNormSynthesisSettings.SIM_DATA_PATH + 
					"/NotConverged" + CommunityNormSynthesisSettings.SIM_FINAL_NORMSETS_FILE
					+ ".plot";
		}
