...
//		
		...
		for(Norm n : applicableNorms){
			...
			if(RunEnvironment.getInstance().isBatch()){
				...
				violateProb = (int)(CommunityNormSynthesisSettings.NORM_VIOLATION_RATE_DOUBLE * 100);
			}else{
				// Decide if applying the norm or not 
				violateProb = (int)(CommunityNormSynthesisSettings.NORM_VIOLATION_RATE_FLOAT * 100);
			}
