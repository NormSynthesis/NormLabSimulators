...
/* USER */
INSERT INTO user (name, surname, password, nickname, mail) VALUES ('*','*','*','*','*');
...
/* SECTION */
INSERT INTO section(id, description) VALUES (0, "*");
...
INSERT INTO complaint_category(id, description) VALUES (5, "insult");

/* MODALITY */
INSERT INTO modality (modality) VALUES ('obl');
INSERT INTO modality (modality) VALUES ('prh');
...
INSERT INTO content(category,section,title,type,url,message) VALUES(5,1, "You suck, your mothers sucks, everyone sucks", "Text","","YOU SUCK!!");

INSERT INTO content(category,section,title,type,url,message) VALUES(5,1, "Really, all of you that insult no stop should feel kinda... dumb or something", "Text","","Yeah thats it, you are lame. Why do you do that? I do not even get it. Just... go fuck yourself or something.");

INSERT INTO content(category,section,title,type,url,message) VALUES(5,1, "I, the greatest Trol on the internet, insult you", "Text","","Oh darling, you, the lowest of the lowest, should be thankful for being insult by me, the gratest Troll ever. Rotten, boring and useless are few of the insults I cannot cointain in me anymore, seriously, your begging for my greatness. Ah... Just being in front of you makes me sick and makes me want to puke, just fall into despair already, would you?");
...
INSERT INTO content(category,section,title,type,url,message) VALUES(5,3, "Giving the finger", "Image","images/jack-wilshere-600x450.jpg","");
INSERT INTO content(category,section,title,type,url,message) VALUES(5,3, "Giving the 'not so usual' finger", "Image","images/ibra.jpg","");
INSERT INTO content(category,section,title,type,url,message) VALUES(5,3, "Giving the finger", "Image","images/Massimo Busacca.jpg","");
