...
IRON_DIR=/Users/Iosu/Documents/workspace/IRON_0.1
...
CLASSPATH=$CLASSPATH $JAVA_EXECUTABLE $JAVA_FLAGS -Xss10M -Xmx400M repast.simphony.batch.BatchMain -params $PROJECT_DIR/batch/batch_params.xml $PROJECT_DIR/virtualCommunities.rs
popd
