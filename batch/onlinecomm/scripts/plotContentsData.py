...
def main(dataFile):
    ...
    # Axis
    plt.xticks(range(0, int(max(xvalues))+1, 5), size='medium')
    ...
    plt.legend(legend, loc='upper center', ncol=2, fancybox=True, shadow=True,
               bbox_to_anchor=(box.width / 1.6, box.height * 1.55), prop={'size': 11})
